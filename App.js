...
const BOT_FEATURES = [
  {
    id: 1,
    name: 'MEL',
    socketurl: `https://${process.env.REACT_APP_RASA_DOMAIN_MEL}`,
    avatar: 'icon-MEL.png',
    color: '#C84945'
  },
  {
    id: 2,
    name: 'MEL2',
    socketurl: `https://${process.env.REACT_APP_RASA_DOMAIN_MEL2}/`,
...
function App() {
  ...
  return (
    <Container onKeyDown={handleKeyDown} color={BOT.color}>
      ...
      <div id="rasa-chat-widget" data-websocket-url={`https://${process.env.REACT_APP_RASA_DOMAIN_MEL}`}></div>
    </Container>
  );
}
